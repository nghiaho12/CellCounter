...
CellCounterFrame::CellCounterFrame(wxWindow* parent,wxWindowID id)
{
    ...
    FlexGridSizer1->Add(m_well_radius_ctrl, 1, wxALL|wxEXPAND, 5);
    ...
    FlexGridSizer1->Add(m_circleness_txt, 1, wxALL|wxEXPAND, 5);
    ...
    FlexGridSizer1->Add(m_keep_cells_ctrl, 1, wxALL|wxEXPAND, 5);
    ...
    FlexGridSizer1->Add(m_select_plate_btn, 1, wxALL|wxEXPAND, 5);
    ...
    FlexGridSizer1->Add(m_count_cells_btn, 1, wxALL|wxEXPAND, 5);
    ...
    FlexGridSizer1->Add(m_total_cells_txt, 1, wxALL|wxEXPAND, 5);
    ...
    FlexGridSizer1->Add(m_clear_btn, 1, wxALL|wxEXPAND, 5);
    ...
    FlexGridSizer1->Add(m_save_results_btn, 1, wxALL|wxEXPAND, 5);
    ...
    BoxSizer2->Add(m_output_txt, 1, wxALL|wxEXPAND, 5);
